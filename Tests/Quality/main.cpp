...
template<bool isItSeeded, typename hashtype, bnch_swt::string_literal libraryName, bnch_swt::string_literal benchmarkColor> void test(const auto hash, const auto* info) {
		...
		
	{
		...
		result &= CyclicKeyTest<isItSeeded, hashtype>(hash, sizeof(hashtype) + 0, 8, 10000000, drawDiagram);
		result &= CyclicKeyTest<isItSeeded, hashtype>(hash, sizeof(hashtype) + 1, 8, 10000000, drawDiagram);
		result &= CyclicKeyTest<isItSeeded, hashtype>(hash, sizeof(hashtype) + 2, 8, 10000000, drawDiagram);
		result &= CyclicKeyTest<isItSeeded, hashtype>(hash, sizeof(hashtype) + 3, 8, 10000000, drawDiagram);
		result &= CyclicKeyTest<isItSeeded, hashtype>(hash, sizeof(hashtype) + 4, 8, 10000000, drawDiagram);
...

	{
		...
		result &= AvalancheTest<isItSeeded, Blob<32>, hashtype>(hash, 300000);
		result &= AvalancheTest<isItSeeded, Blob<40>, hashtype>(hash, 300000);
		result &= AvalancheTest<isItSeeded, Blob<48>, hashtype>(hash, 300000);
		result &= AvalancheTest<isItSeeded, Blob<56>, hashtype>(hash, 300000);

		result &= AvalancheTest<isItSeeded, Blob<64>, hashtype>(hash, 300000);
		result &= AvalancheTest<isItSeeded, Blob<72>, hashtype>(hash, 300000);
		result &= AvalancheTest<isItSeeded, Blob<80>, hashtype>(hash, 300000);
		result &= AvalancheTest<isItSeeded, Blob<88>, hashtype>(hash, 300000);

		result &= AvalancheTest<isItSeeded, Blob<96>, hashtype>(hash, 300000);
		result &= AvalancheTest<isItSeeded, Blob<104>, hashtype>(hash, 300000);
		result &= AvalancheTest<isItSeeded, Blob<112>, hashtype>(hash, 300000);
		result &= AvalancheTest<isItSeeded, Blob<120>, hashtype>(hash, 300000);

		result &= AvalancheTest<isItSeeded, Blob<128>, hashtype>(hash, 300000);
		result &= AvalancheTest<isItSeeded, Blob<136>, hashtype>(hash, 300000);
		result &= AvalancheTest<isItSeeded, Blob<144>, hashtype>(hash, 300000);
		result &= AvalancheTest<isItSeeded, Blob<152>, hashtype>(hash, 300000);
		if (!result) {
			std::cout << "*********FAIL*********" << std::endl;
		} else {
			std::cout << "*********SUCCESS*********" << std::endl;
	...
	/// FAILED TESTS:
...

		{
			...
			result &= ZeroKeyTest<isItSeeded, hashtype>(hash, drawDiagram);
		...
		}
		{
			...
			result &= DiffTest<isItSeeded, Blob<64>, hashtype>(hash, 5, 1000, dumpCollisions);
			result &= DiffTest<isItSeeded, Blob<128>, hashtype>(hash, 4, 1000, dumpCollisions);
			result &= DiffTest<isItSeeded, Blob<256>, hashtype>(hash, 3, 1000, dumpCollisions);
